...
export default {
  ...
  SIGNIN_HEADING: 'Continue With SINE AI 2.0',
  SIGNIN_SUBHEADING: 'To use Sine you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Sine, you agree to the collection of usage data for analytics.',
